    ...
    (e: React.KeyboardEvent<HTMLInputElement>) => {
      if (e.key === 'Enter') {
        ...
        void (async () => {
          ...
          setIsOpen(false);
          // Return focus to the grid canvas after navigation finishes. This keeps
          // the Enter key from being reprocessed by grid-level shortcuts before
          // the target selection is installed.
