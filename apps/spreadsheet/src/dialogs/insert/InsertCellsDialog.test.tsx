...
describe('InsertCellsDialog', () => {
  ...
  it('closes before dispatching the OK action after the close grace period', async () => {
    ...
    jest.advanceTimersByTime(DIALOG_ACTION_CLOSE_DELAY_MS - 1);
    expect(dispatchMock).not.toHaveBeenCalled();
