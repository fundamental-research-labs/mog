...
import { DIALOG_ACTION_DELAY_MS, getPendingDialogActionForTest } from './dialog-action-scheduler';
...
describe('InsertCellsDialog', () => {
  ...
  it('closes before dispatching the OK action after the scheduler delay', async () => {
    ...
    jest.advanceTimersByTime(DIALOG_ACTION_DELAY_MS - 1);
    expect(dispatchMock).not.toHaveBeenCalled();
