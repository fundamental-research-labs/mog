...
export type ActionTarget =
  ...
  | 'object'; // SpreadsheetObjectManager
...
export type EditorKeyboardAction =
  ...
  | { type: 'COMMIT_ENTER' }
  | { type: 'COMMIT_SHIFT_ENTER' }
  | { type: 'COMMIT_TAB' }
  | { type: 'COMMIT_SHIFT_TAB' }
  | { type: 'CANCEL_EDIT' }
  | { type: 'INSERT_NEWLINE' }
  | { type: 'START_FORMULA' }
  ...
  | { type: 'AUTO_SUM' }
  // Formula range extension (Shift+Arrow in formula enter mode)
  | { type: 'FORMULA_EXTEND_UP' }
  | { type: 'FORMULA_EXTEND_DOWN' }
  | { type: 'FORMULA_EXTEND_LEFT' }
  | { type: 'FORMULA_EXTEND_RIGHT' }
  // Ctrl+Arrow / Ctrl+Shift+Arrow in formula enter mode (Excel
  // point-mode jump-to-data-edge / extend-to-data-edge).
  | { type: 'FORMULA_MOVE_TO_EDGE_UP' }
  | { type: 'FORMULA_MOVE_TO_EDGE_DOWN' }
  | { type: 'FORMULA_MOVE_TO_EDGE_LEFT' }
  | { type: 'FORMULA_MOVE_TO_EDGE_RIGHT' }
  | { type: 'FORMULA_EXTEND_TO_EDGE_UP' }
  | { type: 'FORMULA_EXTEND_TO_EDGE_DOWN' }
  | { type: 'FORMULA_EXTEND_TO_EDGE_LEFT' }
  | { type: 'FORMULA_EXTEND_TO_EDGE_RIGHT' };
...
export const ACTION_TARGET_MAP: Record<string, ActionTarget> = {
  ...
  EXTEND_SELECTION_PAGE_UP: 'selection',
  EXTEND_SELECTION_PAGE_DOWN: 'selection',
  ...
  SELECT_CURRENT_ARRAY: 'store', // Needs store access to find array bounds
  ...
  COMMIT_ENTER: 'editor',
  COMMIT_SHIFT_ENTER: 'editor',
  COMMIT_TAB: 'editor',
  COMMIT_SHIFT_TAB: 'editor',
  CANCEL_EDIT: 'editor',
  ...
  AUTO_SUM: 'editor',
  FORMULA_EXTEND_UP: 'editor',
  FORMULA_EXTEND_DOWN: 'editor',
  FORMULA_EXTEND_LEFT: 'editor',
  FORMULA_EXTEND_RIGHT: 'editor',
  FORMULA_MOVE_TO_EDGE_UP: 'editor',
  FORMULA_MOVE_TO_EDGE_DOWN: 'editor',
  FORMULA_MOVE_TO_EDGE_LEFT: 'editor',
  FORMULA_MOVE_TO_EDGE_RIGHT: 'editor',
  FORMULA_EXTEND_TO_EDGE_UP: 'editor',
  FORMULA_EXTEND_TO_EDGE_DOWN: 'editor',
  FORMULA_EXTEND_TO_EDGE_LEFT: 'editor',
  FORMULA_EXTEND_TO_EDGE_RIGHT: 'editor',
