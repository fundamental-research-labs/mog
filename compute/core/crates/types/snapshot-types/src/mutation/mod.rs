...
pub use features::{
    ...
    RangeChangeKind, RuntimeOperationDiagnostic, SlicerChange, SlicerChangeKind, SlicerSourceType,
    SortingChange, StructureChangeResult, StructureChangeType, TableChange,
};
