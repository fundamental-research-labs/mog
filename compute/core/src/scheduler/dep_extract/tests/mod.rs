...
// ===========================================================================
    ...
    fn test_named_rect_range_preserves_resolved_range_dep() {
        ...
        let sheet = make_sheet_id(1);
        let rows = vec![RowId::from_raw(10), RowId::from_raw(11), RowId::from_raw(12)];
        let cols = vec![ColId::from_raw(20), ColId::from_raw(21), ColId::from_raw(22)];
    ...
    fn test_structured_ref_under_selective_context_skips_cell_expansion() {
        ...
        assert!(deps.iter().any(|dep| matches!(
            dep,
            DepTarget::Range(_, RangeAccess::Selective)
        )));
        assert!(
