...
impl ComputeCore {
    ...
    pub(super) fn selective_dep_fixup_pass(
        &mut self,
        mirror: &mut CellMirror,
        epoch_range_store: &mut crate::eval::cache::range_store::RangeStore,
        metrics: &mut RecalcMetrics,
        ...
        #[cfg(feature = "native")]
        let use_parallel = fixup_cells.len() >= super::level_eval::PARALLEL_THRESHOLD;
        #[cfg(not(feature = "native"))]
        let use_parallel = false;
        ...
        if !changed_cells.is_empty() {
            ...
            if !downstream.is_empty() {
                ...
                for level in &downstream_levels {
                    ...
                    #[cfg(feature = "native")]
                    let use_parallel = dirty_level.len() >= super::level_eval::PARALLEL_THRESHOLD;
                    #[cfg(not(feature = "native"))]
                    let use_parallel = false;
