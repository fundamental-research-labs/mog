...
pub(super) fn create_filter(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
...
pub(super) fn delete_filter(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        filter_id: &str,
    ) -> Result<(Vec<u8>, MutationResult), ComputeError> {
        let mut result =
...
pub(super) fn set_column_filter(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        filter_id: &str,
        header_col: u32,
...
pub(super) fn clear_column_filter(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        filter_id: &str,
        header_col: u32,
    ) -> Result<(Vec<u8>, MutationResult), ComputeError> {
...
pub(super) fn clear_all_column_filters(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        filter_id: &str,
    ) -> Result<(Vec<u8>, MutationResult), ComputeError> {
...
pub(super) fn get_filters_in_sheet(engine: &YrsComputeEngine, sheet_id: &SheetId) -> Vec<filters::FilterState> {
        filter_svc::get_filters_in_sheet(&engine.stores, &engine.mirror, sheet_id)
    }

pub(super) fn apply_advanced_filter(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
...
pub(super) fn apply_filter(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        filter_id: &str,
    ) -> Result<(Vec<u8>, MutationResult), ComputeError> {
        let mut result =
...
pub(super) fn get_unique_column_values(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
        filter_id: &str,
        header_col: u32,
    ) -> Vec<CellValue> {
...
pub(super) fn compute_dynamic_filter_serial_range(engine: &YrsComputeEngine,
...
pub(super) fn get_filter(engine: &YrsComputeEngine, sheet_id: &SheetId, filter_id: &str) -> Option<filters::FilterState> {
...
pub(super) fn get_table_filter(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
        table_id: &str,
...
pub(super) fn get_active_filters(engine: &YrsComputeEngine, sheet_id: &SheetId) -> Vec<filters::FilterState> {
...
pub(super) fn set_filter_sort_state(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        filter_id: &str,
...
pub(super) fn get_filter_sort_state(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
        filter_id: &str,
...
pub(super) fn clear_all_filters(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
    ) -> Result<(Vec<u8>, MutationResult), ComputeError> {
...
pub(super) fn get_filtered_record_count(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
        filter_id: &str,
