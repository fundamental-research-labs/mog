...
pub(super) fn sort_range(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        start_row: u32,
        start_col: u32,
        end_row: u32,
        ...
        match engine.apply_mutation(crate::storage::engine::mutation::EngineMutation::SortRange {
            sheet_id: *sheet_id,
            start_row,
            start_col,
            end_row,
...
pub(super) fn auto_fill(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        ...
        match engine.apply_mutation(crate::storage::engine::mutation::EngineMutation::AutoFill {
            ...
            crate::storage::engine::mutation::MutationOutput::Recalc(r) => Ok((engine.flush_viewport_patches(), r)),
            _ => Ok((
                compute_wire::mutation::serialize_multi_viewport_patches(&[]),
                MutationResult::empty(),
            )),
...
pub(super) fn flash_fill(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        request: crate::engine_types::fill::BridgeFlashFillRequest,
    ) -> Result<(Vec<u8>, MutationResult), ComputeError> {
        match engine.apply_mutation(crate::storage::engine::mutation::EngineMutation::FlashFill {
            sheet_id: *sheet_id,
            request,
        })? {
            crate::storage::engine::mutation::MutationOutput::Recalc(r) => Ok((engine.flush_viewport_patches(), r)),
...
pub(super) fn copy_range(engine: &mut YrsComputeEngine,
        ...
        match engine.apply_mutation(crate::storage::engine::mutation::EngineMutation::CopyRange {
...
pub(super) fn remove_duplicates(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        start_row: u32,
        start_col: u32,
        end_row: u32,
        ...
        let sid = *sheet_id;
        match engine.apply_mutation(crate::storage::engine::mutation::EngineMutation::RemoveDuplicates {
            sheet_id: sid,
            start_row,
            start_col,
            end_row,
...
pub(super) fn check_sort_range_merges(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
        start_row: u32,
        start_col: u32,
        end_row: u32,
