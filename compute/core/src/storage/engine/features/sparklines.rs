...
pub(super) fn add_sparkline(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
...
pub(super) fn update_sparkline(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        sparkline_id: &str,
...
pub(super) fn delete_sparkline(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        sparkline_id: &str,
    ) -> Result<(Vec<u8>, MutationResult), ComputeError> {
...
pub(super) fn get_sparklines_in_sheet(engine: &YrsComputeEngine, sheet_id: &SheetId) -> Vec<sparklines::Sparkline> {
        svc::get_sparklines_in_sheet(&engine.stores, sheet_id)
    }

pub(super) fn get_sparkline(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
        sparkline_id: &str,
...
pub(super) fn get_sparkline_at_cell(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
        row: u32,
        col: u32,
    ) -> Option<sparklines::Sparkline> {
...
pub(super) fn add_sparkline_group(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
...
pub(super) fn get_sparkline_group(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
        group_id: &str,
...
pub(super) fn get_sparkline_groups_in_sheet(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
    ) -> Vec<sparklines::SparklineGroup> {
        svc::get_sparkline_groups_in_sheet(&engine.stores, sheet_id)
    }

pub(super) fn delete_sparkline_group(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        group_id: &str,
...
pub(super) fn clear_sparklines_in_range(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        start_row: u32,
        start_col: u32,
        end_row: u32,
...
pub(super) fn clear_sparklines_for_sheet(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
    ) -> Result<(Vec<u8>, MutationResult), ComputeError> {
...
pub(super) fn has_sparkline(engine: &YrsComputeEngine, sheet_id: &SheetId, row: u32, col: u32) -> bool {
