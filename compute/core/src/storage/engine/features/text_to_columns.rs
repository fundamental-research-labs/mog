...
pub(super) fn text_to_columns(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        start_row: u32,
        end_row: u32,
        source_col: u32,
...
pub(super) fn text_to_columns_simple(engine: &mut YrsComputeEngine,
        sheet_id: &SheetId,
        start_row: u32,
        end_row: u32,
        source_col: u32,
...
pub(super) fn preview_text_to_columns(engine: &YrsComputeEngine,
        sheet_id: &SheetId,
