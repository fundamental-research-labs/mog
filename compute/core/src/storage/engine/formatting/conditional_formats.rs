use super::*;
    ...
    pub(super) fn get_all_cf_rules(engine: &YrsComputeEngine, sheet_id: &SheetId) -> Vec<ConditionalFormat>{
    ...
    pub(super) fn has_cf_for_cell(engine: &YrsComputeEngine, sheet_id: &SheetId, row: u32, col: u32) -> bool{
