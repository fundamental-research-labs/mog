...
impl ComputeEngine {
    ...
    pub(super) fn apply_hide_rows(
        ...
        services::structural::hide_rows(&mut self.stores, &self.cell_store, sheet_id, rows)
    }
    ...
    pub(super) fn apply_unhide_rows(
        ...
        services::structural::unhide_rows(&mut self.stores, &self.cell_store, sheet_id, rows)
    }
    ...
    pub(super) fn apply_hide_columns(
        ...
        services::structural::hide_columns(&mut self.stores, &self.cell_store, sheet_id, cols)
    }
    ...
    pub(super) fn apply_unhide_columns(
        ...
        services::structural::unhide_columns(&mut self.stores, &self.cell_store, sheet_id, cols)
    }
}
