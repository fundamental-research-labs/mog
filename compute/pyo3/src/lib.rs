//! PyO3 binding layer for compute-core.
//!
...
use compute_table::types::{
    ...
    SlicerSortOrder, SortSpec, Table, TableCellFormat, TableColumn, TableRange,
...
// XLSX parser bridge type: merged into compute-core PyO3 module.
#[allow(unused_imports)]
