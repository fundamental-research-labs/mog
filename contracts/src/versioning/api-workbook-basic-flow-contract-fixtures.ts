...
const scenarioBranchName = 'scenario/basic-flow' as ContractsApi.VersionBranchName;
const scenarioRefName = 'refs/heads/scenario/basic-flow' as ContractsApi.VersionRefName;
