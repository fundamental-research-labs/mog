...
import type { WorkbookVersion as WorkbookEntryWorkbookVersion } from '@mog-sdk/contracts/api/workbook';
import type {
...
>;
type _ContractsVersionStoreDiagnosticsExposeUnsupportedRecoverability = Assert<
  IsEqual<Extract<VersionStoreDiagnostic['recoverability'], 'unsupported'>, 'unsupported'>
>;
type _ContractsWorkbookVersionApplyMergeFixturesCoverResultStatuses = Assert<
  IsEqual<
    (typeof workbookVersionApplyMergeResultFixtures)[number]['status'],
    VersionApplyMergeResult['status']
  >
>;
type _ContractsWorkbookVersionRevertFixturesCoverResultStatuses = Assert<
  IsEqual<
    (typeof workbookVersionRevertResultFixtures)[number]['status'],
    VersionRevertResult['status']
  >
>;
type _ContractsVersionMergeEndpointsExposeDeniedStatuses = Assert<
  IsEqual<
    Extract<
      VersionMergeEndpointDeniedStatus,
  ...
  >
>;
type _ContractsVersionHistoryDeniedSummaryKindSet = Assert<
  IsEqual<VersionHistoryDeniedSummaryKind, 'capability-denied' | 'access-denied'>
>;
type _ContractsVersionHistoryDeniedSummaryCodes = Assert<
  IsEqual<
    Extract<
      VersionHistoryAccessDeniedSummary['code'],
      'version_capability_unavailable' | 'version_access_denied'
    >,
    'version_capability_unavailable' | 'version_access_denied'
  >
>;
type _ContractsVersionDiagnosticsExposePermissionDeniedCode = Assert<
  IsEqual<Extract<VersionDiagnosticCode, 'VERSION_PERMISSION_DENIED'>, 'VERSION_PERMISSION_DENIED'>
>;
type _ContractsVersionDiagnosticsExposeUnsupportedPageTokenCode = Assert<
  IsEqual<
    Extract<VersionDiagnosticCode, 'VERSION_UNSUPPORTED_PAGE_TOKEN'>,
    'VERSION_UNSUPPORTED_PAGE_TOKEN'
  >
>;
type _ContractsPublicDiagnosticEnvelopesHaveNoPrivateFields = Assert<
  IsEqual<
    Extract<
      KeysOfUnion<
        | VersionDiagnostic
  ...
  >
>;
type _ContractsWorkbookVersionResultValuesHaveNoTopLevelPrivateFields = Assert<
  IsEqual<
    Extract<
      KeysOfUnion<
        UnwrapVersionResult<
