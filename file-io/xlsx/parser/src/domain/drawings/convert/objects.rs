...
fn convert_drawing_content_for_group_with_outcome(
    content: &read::DrawingContent,
...
pub fn convert_drawing_content_with_outcome(
    ...
    match content {
        ...
        read::DrawingContent::SmartArt(sa) => {
            ...
            DrawingConversionOutcome::emitted(
                write::DrawingObject::SmartArt(write::SmartArtWriteData {
                    original_id: None,
...
fn relationship_ids_for_group(group: &read::GroupShape) -> Vec<String> {
...
#[cfg(test)]
mod tests {
    use super::super::outcome::ConversionStatus;
    use super::*;
    ...
    fn test_convert_drawing_content_shape_returns_text_box() {
        ...
        match result.unwrap() {
            write::DrawingObject::TextBox(_) => {} // expected
