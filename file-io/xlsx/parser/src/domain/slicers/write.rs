...
mod tests {
    ...
    fn test_write_slicer_part_single() {
        ...
        assert!(
            xml_str
                .contains("xmlns:x=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\"")
        );
    ...
    fn test_roundtrip_6h_cross_filter_and_sort_order() {
        ...
        let parsed_x14 = crate::domain::slicers::read::parse_slicer_cache(&xml_x14)
            .expect("x14 cache should parse");
        ...
        let parsed_x15 = crate::domain::slicers::read::parse_slicer_cache(&xml_x15)
            .expect("x15 cache should parse");
        let tsc = parsed_x15
            .table_slicer_cache
            .expect("Should have table slicer cache");
        assert_eq!(
