...
fn domain_empty_cell_display_str(display: &EmptyCellDisplay) -> &'static str {
    match display {
...
fn append_sparkline_ext_lst_open(xml: &mut String) {
    xml.push_str("<extLst>");
...
fn append_sparkline_ext_lst_close(xml: &mut String) {
