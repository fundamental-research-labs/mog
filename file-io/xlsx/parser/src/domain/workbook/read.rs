...
pub use inventory::{
    SheetPackageContext, build_workbook_sheet_inventory, sheet_package_contexts,
};
pub use properties::{
    parse_file_sharing, parse_file_version, parse_web_publishing,
...
mod tests {
    ...
    fn legacy_read_imports_resolve() {
        ...
        let _all_rels: Vec<ooxml_types::shared::OpcRelationship> =
            parse_all_rels(b"");
        let _calc: CalcPrSettings = parse_calc_settings(b"");
        let _views: Vec<crate::domain::workbook::types::WorkbookView> =
            parse_workbook_views(b"");
        let _workbook_properties: Option<
            domain_types::domain::workbook::WorkbookProperties,
        ...
        let _web_publishing: Option<
            domain_types::domain::workbook::WorkbookWebPublishing,
