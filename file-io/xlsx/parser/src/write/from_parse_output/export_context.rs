...
pub(super) struct WorksheetRelationshipPlan {
    ...
    pub(super) worksheet_header_footer_vml_relationships:
        Vec<WorksheetHeaderFooterVmlGraphEntry>,
    ...
    pub(super) worksheet_threaded_comments_relationships:
        Vec<WorksheetThreadedCommentsGraphEntry>,
    pub(super) worksheet_table_relationships: Vec<(usize, usize)>,
