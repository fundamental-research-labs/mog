use super::{
    ...
    CT_CHART_USER_SHAPES, CT_COMMENTS, CT_CONNECTIONS, CT_DRAWING, CT_EMF, CT_FEATURE_PROPERTY_BAG,
    CT_GIF, CT_JPEG, CT_PIVOT_CACHE, CT_PIVOT_CACHE_RECORDS, CT_PIVOT_TABLE, CT_PNG,
    CT_PRINTER_SETTINGS, CT_QUERY_TABLE, CT_SLICER, CT_SLICER_CACHE, CT_TABLE,
    CT_TABLE_SINGLE_CELLS, CT_THREADED_COMMENTS, CT_TIMELINE, CT_TIMELINE_CACHE, CT_VML_DRAWING,
