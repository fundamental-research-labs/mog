...
use super::{
    ...
    CT_COMMENTS, CT_CONNECTIONS, CT_CORE_PROPERTIES, CT_CUSTOM_PROPERTIES, CT_DOC_METADATA_LABEL_INFO,
    CT_DRAWING, CT_EXTENDED_PROPERTIES, CT_METADATA, CT_OLE_OBJECT, CT_PIVOT_CACHE,
    CT_PIVOT_CACHE_RECORDS, CT_PIVOT_TABLE, CT_QUERY_TABLE, CT_SHARED_STRINGS, CT_SLICER,
    CT_SLICER_CACHE, CT_STYLES, CT_TABLE, CT_THEME, CT_THREADED_COMMENTS,
    CT_WORKBOOK, CT_WORKSHEET, CT_WORKSHEET_CUSTOM_PROPERTY, PackageIntegrityIssue, PackagePart,
    ...
    ResolvedPackageRelationship, relationship_target_part_path, owner_part_path_from_rels_path,
};
use crate::infra::opc::OoxmlRelationshipType;

pub(super) fn validate_required_content_type(part: &PackagePart, errors: &mut Vec<PackageIntegrityIssue>) {
