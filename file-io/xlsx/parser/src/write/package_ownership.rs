...
pub struct OoxmlOwnershipRow {
    ...
    pub app_persistence_owner: &'static str,
...
pub const CURRENT_STATE_OWNER_POLICY_TABLE: &[CurrentStateOwnerPolicy] = &[
    ...
    CurrentStateOwnerPolicy {
        owner: PackageFeatureOwner::ConnectionsAndQueryTables,
        owner_id: XlsxPackageOwnerId::ConnectionsAndQueryTables,
        ...
        typed_import_fields: &[
            "supported connection/query table fields",
            "valid source XML for unknown namespaces, attributes, and children",
        ],
        provenance_only_fields: &[
            "connection source XML namespace/extension metadata",
            "external target spelling",
            "relationship id",
            "part path",
        ],
        closure_requirements: &[
        ...
        currentness_validator: "raw source XML may replay only while the typed connection projection fingerprint is current; edited state uses the typed writer",
        export_action: XlsxExportAction::TypedWithValidatedProvenance,
        diagnostic_code: "xlsx.connections.rewrittenFromLiveState",
        diagnostic_severity: XlsxDiagnosticSeverity::Info,
        diagnostic_reason: XlsxDiagnosticReason::CanonicalFreshExportPolicy,
        continuation: XlsxDiagnosticContinuation::ExportContinued,
        required_tests: ALL_OWNER_POLICY_TESTS,
...
pub const ROUND_9_OOXML_OWNERSHIP_MATRIX: &[OoxmlOwnershipRow] = &[
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "workbook/sheet app state; calc-chain intentionally not persisted",
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "sheet/cell app state where modeled; diagnostics for gaps",
        api_exposure: ApiExposureLevel::Editable,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "cell/style/theme app state",
        api_exposure: ApiExposureLevel::Editable,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "cell, row, column, dimension, and range style state",
        api_exposure: ApiExposureLevel::Editable,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "native table catalog plus workbook connection metadata; unreferenced connections survive export",
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "drawing/chart app state where modeled",
        api_exposure: ApiExposureLevel::ReadOnly,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "comment/control state where modeled",
        api_exposure: ApiExposureLevel::ReadOnly,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "floating object app state",
        api_exposure: ApiExposureLevel::ReadOnly,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "diagnostic-only",
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "pivot/slicer/metadata state where modeled; typed WorkbookMetadata preserves metadata.xml provenance and richData package facts; WorkbookDataFeatures projection rebuilt on export",
        api_exposure: ApiExposureLevel::ReadOnly,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "native external-link metadata with imported cache payloads",
        api_exposure: ApiExposureLevel::ReadOnly,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "document metadata where exposed; custom XML binding pending plan 05",
        api_exposure: ApiExposureLevel::ReadOnly,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "diagnostic-only unless a future plan adds typed state",
        api_exposure: ApiExposureLevel::DiagnosticOnly,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "package fidelity metadata",
        api_exposure: ApiExposureLevel::DiagnosticOnly,
    ...
    OoxmlOwnershipRow {
        ...
        app_persistence_owner: "typed workbook volatile-dependency package part and workbook metadata",
        api_exposure: ApiExposureLevel::DiagnosticOnly,
