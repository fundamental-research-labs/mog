...
| `FullParsedSheet.comments_root_namespace_attrs` | Unsupported lexical sidecar | none | dropped-import diagnostic | Comment export uses current comment owner state only |
