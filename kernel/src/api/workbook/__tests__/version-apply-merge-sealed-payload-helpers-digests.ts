...
import type { ObjectDigest as VersionStoreObjectDigest } from '../../../document/version-store/object-digest';
...
export function internalSha256Digest(digest: ObjectDigest): VersionStoreObjectDigest {
...
export function compactStrings(values: readonly unknown[]): readonly string[] {
