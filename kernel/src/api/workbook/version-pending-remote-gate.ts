...
import { REQUIRED_PROMOTION_CAPABILITIES } from './version-pending-remote-constants';
import { noWriteDiagnostic } from './version-pending-remote-diagnostics';
import type { MaybeVersionRuntimeContext } from './version-pending-remote-types';
import { isRecord } from './version-pending-remote-utils';
