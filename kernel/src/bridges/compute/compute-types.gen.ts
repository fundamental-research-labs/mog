...
import type { SpreadsheetGraphicFrame } from '../../../../infra/rust-bridge/bridge-ts/generated/ooxml-types';
...
export interface ChartRoundTripData {
  ...
  date1904?: boolean;
  lang?: string;
  chartSpaceExtensions?: unknown[];
  chartExtensions?: unknown[];
  plotAreaExtensions?: unknown[];
  hasEmptyChartExtLst?: boolean;
  plotAreaLayout?: unknown;
  styleAlternateContent?: string;
  styleAfterChart?: boolean;
  auxiliaryFiles?: [string, Uint8Array][];
  chartRelsBytes?: [string, Uint8Array];
}
...
export type ImportFeatureKind = "workbook" | "worksheet" | "cell" | "formula" | "style" | "theme" | "chart" | "diagram" | "textEffects" | "drawing" | "image" | "table" | "pivotTable" | "slicer" | "conditionalFormat" | "dataValidation" | "comment" | "hyperlink" | "protection" | "printSettings" | "externalLink" | "macro" | "metadata" | "unknown";
