...
import type { CellValue, CellFormat, CellBorders } from '@mog-sdk/contracts/core';
...
export type BorderPatchField = "top" | "right" | "bottom" | "left" | "diagonal" | "diagonalUp" | "diagonalDown" | "vertical" | "horizontal" | "outline";

export interface BorderPatchOperation {
  target: BorderPatchTarget;
  borders: CellBorders;
  clearFields: BorderPatchField[];
}

export type BorderPatchTarget =
  | { kind: "cells" } & BorderPatchTarget_cells
  | { kind: "row" } & BorderPatchTarget_row
  | { kind: "column" } & BorderPatchTarget_column;

export interface BorderPatchTarget_cells {
  startRow: number;
  startCol: number;
  endRow: number;
  endCol: number;
...
export interface BorderPatchTarget_column {
  col: number;
}

export interface BorderPatchTarget_row {
  row: number;
}
