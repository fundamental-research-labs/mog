...
const JOIN_REQUEST_BYTES = [
  0x01, 0x7b, 0x22, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x49,
  0x64, 0x22, 0x3a, 0x22, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x31, 0x22, 0x7d,
];

const PUSH_BYTES = [
  0x03, 0x00, 0x00, 0x00, 0x29, 0x7b, 0x22, 0x74, 0x6f, 0x75, 0x63, 0x68, 0x65, 0x64, 0x53,
  0x68, 0x65, 0x65, 0x74, 0x73, 0x22, 0x3a, 0x5b, 0x22, 0x73, 0x68, 0x65, 0x65, 0x74, 0x31,
  0x22, 0x5d, 0x2c, 0x22, 0x73, 0x76, 0x22, 0x3a, 0x5b, 0x31, 0x2c, 0x32, 0x2c, 0x33, 0x5d,
  0x7d, 10, 20, 30, 40,
];

const BROADCAST_NUDGE_BYTES = [
  0x0c, 0x00, 0x00, 0x00, 0x12, 0x7b, 0x22, 0x62, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73,
  0x74, 0x22, 0x3a, 0x74, 0x72, 0x75, 0x65, 0x7d, 5, 6, 7,
];
