...
function reviewStore(): InMemoryWorkbookVersionReviewRecordStore {
...
function unsupportedApprovalEvidence(): WorkbookVersionReviewApprovalEvidence {
...
function unsupportedDiffPage(): WorkbookVersionReviewDiffPage {
  const target = unsupportedTarget();
  return {
    schemaVersion: 1,
...
function unsupportedTarget(): Extract<
  WorkbookVersionReviewDecisionTarget,
