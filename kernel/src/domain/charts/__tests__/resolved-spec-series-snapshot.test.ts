...
describe('resolved spec series snapshot helpers', () => {
  ...
  it('summarizes rendered and dropped series projection state', () => {
    ...
    expect(snapshotSeriesProjection(config, data, [rendered])).toEqual({
      ...
      sourceSeries: [
        {
          ...
          source: {
            values: 'Sheet1!A1:A2',
            valueSourceKind: undefined,
            categories: undefined,
            categorySourceKind: undefined,
            bubbleSize: undefined,
            bubbleSizeSourceKind: undefined,
            stockRole: undefined,
          },
        },
        {
      ...
      projectedRoleMappings: undefined,
      stockRenderProjection: undefined,
      droppedSeries: [
        {
          sourceSeriesIndex: 5,
          sourceSeriesKey: 'series:5',
