...
export const WORKBOOK_SUB_API_INTERFACES: WorkbookSubApiInterfaces = {
  ...
  VersionMergeReviewArtifactNamespace: {
    advanced: {
      ...
      docstring: '',
      usedTypes: ['VersionMergeReviewArtifactApi'],
      stableId: 'VersionMergeReviewArtifactNamespace.advanced',
      canonicalPath: 'wb.version.artifacts.advanced',
      root: 'subApi',
      parentRoot: 'workbook',
      interface: 'VersionMergeReviewArtifactNamespace',
      method: 'advanced',
      kind: 'property',
      visibility: 'public',
      asyncModel: 'sync',
      ...
      returns: {
        type: {
          kind: 'objectRef',
          name: 'VersionMergeReviewArtifactApi',
        },
        typeText: 'VersionMergeReviewArtifactApi',
      },
      typeScript: {
        signature: 'readonly advanced: VersionMergeReviewArtifactApi;',
        parameters: [],
        returnTypeText: 'VersionMergeReviewArtifactApi',
      },
      ownership: {
        package: '@mog/types-api',
      },
      ...
      compatibility: [],
      source: {
        file: 'types/api/src/api/workbook/version-merge-review.ts',
      },
  ...
  VersionProposalPorcelainApi: {
    advanced: {
      ...
      docstring: '',
      usedTypes: ['VersionProposalApi'],
      stableId: 'VersionProposalPorcelainApi.advanced',
      canonicalPath: 'wb.version.proposals.advanced',
      root: 'subApi',
      parentRoot: 'workbook',
      interface: 'VersionProposalPorcelainApi',
      method: 'advanced',
      kind: 'property',
      visibility: 'public',
      asyncModel: 'sync',
      ...
      returns: {
        type: {
          kind: 'objectRef',
          name: 'VersionProposalApi',
        },
        typeText: 'VersionProposalApi',
      },
      typeScript: {
        signature: 'readonly advanced: VersionProposalApi;',
        parameters: [],
        returnTypeText: 'VersionProposalApi',
      },
      ownership: {
        package: '@mog/types-api',
      },
      ...
      compatibility: [],
      source: {
        file: 'types/api/src/api/workbook/version-proposal.ts',
      },
  ...
  WorkbookVersion: {
    artifacts: {
      ...
      docstring: '',
      usedTypes: ['VersionMergeReviewArtifactNamespace'],
      stableId: 'WorkbookVersion.artifacts',
      canonicalPath: 'wb.version.artifacts',
      root: 'subApi',
      parentRoot: 'workbook',
      ...
      returns: {
        type: {
          kind: 'objectRef',
          name: 'VersionMergeReviewArtifactNamespace',
        },
        typeText: 'VersionMergeReviewArtifactNamespace',
      },
      typeScript: {
        signature: 'readonly artifacts: VersionMergeReviewArtifactNamespace;',
        parameters: [],
        returnTypeText: 'VersionMergeReviewArtifactNamespace',
      },
      ownership: {
        package: '@mog/types-api',
      },
    ...
    proposals: {
      ...
      docstring: '',
      usedTypes: ['VersionProposalPorcelainApi'],
      stableId: 'WorkbookVersion.proposals',
      canonicalPath: 'wb.version.proposals',
      root: 'subApi',
      parentRoot: 'workbook',
      interface: 'WorkbookVersion',
      method: 'proposals',
      ...
      returns: {
        type: {
          kind: 'objectRef',
          name: 'VersionProposalPorcelainApi',
        },
        typeText: 'VersionProposalPorcelainApi',
      },
      typeScript: {
        signature: 'readonly proposals: VersionProposalPorcelainApi;',
        parameters: [],
        returnTypeText: 'VersionProposalPorcelainApi',
      },
      ownership: {
        package: '@mog/types-api',
      },
    ...
    reviews: {
      ...
      docstring: '',
      usedTypes: ['WorkbookVersionReviewNamespace'],
      stableId: 'WorkbookVersion.reviews',
      canonicalPath: 'wb.version.reviews',
      root: 'subApi',
      parentRoot: 'workbook',
      interface: 'WorkbookVersion',
      method: 'reviews',
      ...
      returns: {
        type: {
          kind: 'objectRef',
          name: 'WorkbookVersionReviewNamespace',
        },
        typeText: 'WorkbookVersionReviewNamespace',
      },
      typeScript: {
        signature: 'readonly reviews: WorkbookVersionReviewNamespace;',
        parameters: [],
        returnTypeText: 'WorkbookVersionReviewNamespace',
      },
      ownership: {
        package: '@mog/types-api',
      },
  ...
  WorkbookVersionReviewNamespace: {
    advanced: {
      ...
      docstring: '',
      usedTypes: ['WorkbookVersionReviewApi'],
      stableId: 'WorkbookVersionReviewNamespace.advanced',
      canonicalPath: 'wb.version.reviews.advanced',
      root: 'subApi',
      parentRoot: 'workbook',
      interface: 'WorkbookVersionReviewNamespace',
      method: 'advanced',
      kind: 'property',
      visibility: 'public',
      asyncModel: 'sync',
      ...
      returns: {
        type: {
          kind: 'objectRef',
          name: 'WorkbookVersionReviewApi',
        },
        typeText: 'WorkbookVersionReviewApi',
      },
      typeScript: {
        signature: 'readonly advanced: WorkbookVersionReviewApi;',
        parameters: [],
        returnTypeText: 'WorkbookVersionReviewApi',
      },
      ownership: {
        package: '@mog/types-api',
      },
      ...
      compatibility: [],
      source: {
        file: 'types/api/src/api/workbook/version-review.ts',
      },
  ...
  WorksheetProtection: {
    allowEditRanges: {
      signature: 'readonly allowEditRanges: WorksheetAllowEditRanges;',
      docstring: 'Collection of ranges that can be edited even when the sheet is protected.',
      usedTypes: ['WorksheetAllowEditRanges'],
      stableId: 'WorksheetProtection.allowEditRanges',
      canonicalPath: 'ws.protection.allowEditRanges',
      root: 'subApi',
      parentRoot: 'worksheet',
      interface: 'WorksheetProtection',
      method: 'allowEditRanges',
      kind: 'property',
      visibility: 'public',
      asyncModel: 'sync',
      parameters: [],
      returns: {
        type: {
          kind: 'objectRef',
          name: 'WorksheetAllowEditRanges',
        },
        typeText: 'WorksheetAllowEditRanges',
      },
      typeScript: {
        signature: 'readonly allowEditRanges: WorksheetAllowEditRanges;',
        parameters: [],
        returnTypeText: 'WorksheetAllowEditRanges',
      },
      ownership: {
        package: '@mog/types-api',
      },
      ...
      compatibility: [],
      source: {
        file: 'types/api/src/api/worksheet/protection.ts',
      },
      targetInterface: 'WorksheetAllowEditRanges',
    },
  },
  WorksheetTables: {
    events: {
      signature: 'readonly events: WorksheetTableEvents;',
      docstring: 'Event subscription sub-namespace.',
      usedTypes: ['WorksheetTableEvents'],
      stableId: 'WorksheetTables.events',
      canonicalPath: 'ws.tables.events',
      root: 'subApi',
      parentRoot: 'worksheet',
      interface: 'WorksheetTables',
      method: 'events',
      kind: 'property',
      visibility: 'public',
      asyncModel: 'sync',
      ...
      returns: {
        type: {
          kind: 'objectRef',
          name: 'WorksheetTableEvents',
        },
        typeText: 'WorksheetTableEvents',
      },
      typeScript: {
        signature: 'readonly events: WorksheetTableEvents;',
        parameters: [],
        returnTypeText: 'WorksheetTableEvents',
      },
      ownership: {
        package: '@mog/types-api',
      },
      ...
      compatibility: [],
      source: {
        file: 'types/api/src/api/worksheet/tables.ts',
      },
      targetInterface: 'WorksheetTableEvents',
    },
    sort: {
      signature: 'readonly sort: WorksheetTableSort;',
      docstring: 'Sort operations sub-namespace.',
      usedTypes: ['WorksheetTableSort'],
      stableId: 'WorksheetTables.sort',
      canonicalPath: 'ws.tables.sort',
      root: 'subApi',
      parentRoot: 'worksheet',
      interface: 'WorksheetTables',
      method: 'sort',
      ...
      returns: {
        type: {
          kind: 'objectRef',
          name: 'WorksheetTableSort',
        },
        typeText: 'WorksheetTableSort',
      },
      typeScript: {
        signature: 'readonly sort: WorksheetTableSort;',
        parameters: [],
        returnTypeText: 'WorksheetTableSort',
      },
      ownership: {
        package: '@mog/types-api',
      },
      ...
      targetInterface: 'WorksheetTableSort',
    },
  },
};
