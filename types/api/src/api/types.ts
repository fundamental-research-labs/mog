...
} from '@mog/types-events/settings-events';
...
// === Stable API identifiers shared across workbook submodules ===
...
export interface GoalSeekResult {
  ...
  value?: number;
  /** The value the target (formula) cell achieves at the solution (if found) */
...
export type { WorkbookSettings, WorkbookSettingsPatch } from '@mog/types-core/core';
...
export interface WorkbookEventMap {
  ...
  'cells:policy-preserved': WorkbookPolicyPreservedEvent;
}
