...
export type {
  RedactionPolicy, RedactedVersionAuthor, VersionAnnotationText, VersionBranchName,
  ...
  VersionCommitish,
  VersionCommitExpectedHead, VersionCommitMode, VersionCommitOptions, VersionCommitPage,
  VersionCreateBranchOptions,
  VersionDegradedHeadResult,
  VersionDeleteRefOptions,
  VersionDiffDisplay, VersionDiffDisplayValue, VersionDiffEntry, VersionDiffOptions,
  VersionDiffStructuralMetadata, VersionDiffValue,
  ...
  VersionMergeInput,
  VersionMergeMutationGuarantee, VersionMergeOptions, VersionMergeResult,
  VersionCapability, VersionCapabilityDependency, VersionCapabilityState,
  ...
  VersionSurfaceDiagnosticCode, VersionSurfaceDiagnosticSeverity,
  VersionSurfaceStage, VersionSurfaceStatus, VersionSurfaceStorageBackend,
  VersionSymbolicRef, VersionSymbolicRefReadResult, VersionUpdateBranchOptions,
  WorkbookCommitAnnotationSummary,
  WorkbookCommitId, WorkbookCommitRef, WorkbookCommitSummary,
  WorkbookDiffPage,
  WorkbookVersion,
