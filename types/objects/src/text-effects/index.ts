 ...
 * Text-Effect Types
 *
 * Type definitions for text-effect text effects (DrawingML text warp).
 * Decorative text is implemented as an extension to TextBoxObject.
 *
 * @example
 * import {
 *   TextEffectConfig,
