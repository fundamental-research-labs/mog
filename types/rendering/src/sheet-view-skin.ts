...
import { DEFAULT_CHROME_THEME } from '@mog/types-viewport/rendering/data-source-types';
...
export const DEFAULT_RESOLVED_SHEET_VIEW_SKIN: ResolvedSheetViewSkin = {
  ...
  formulaRefColors: [
    { stroke: '#1a73e8', fill: 'rgba(26, 115, 232, 0.08)' },
    { stroke: '#d93025', fill: 'rgba(217, 48, 37, 0.08)' },
    { stroke: '#188038', fill: 'rgba(24, 128, 56, 0.08)' },
    { stroke: '#f9ab00', fill: 'rgba(249, 171, 0, 0.08)' },
    { stroke: '#9334e6', fill: 'rgba(147, 52, 230, 0.08)' },
    { stroke: '#00acc1', fill: 'rgba(0, 172, 193, 0.08)' },
  ],
  controls: {
    commentIndicator: '#fbbc04',
    validationDropdown: '#5f6368',
    validationError: '#d93025',
    filterIcon: '#5f6368',
    filterActiveIcon: '#1a73e8',
    checkboxBorder: '#5f6368',
    checkboxCheck: '#ffffff',
    checkboxBackground: '#1a73e8',
    autofillHandle: DEFAULT_CHROME_THEME.fillHandleColor,
    frozenPaneDivider: '#80868b',
    hiddenIndicator: '#9aa0a6',
  },
  overlays: {
    pastePreviewFill: 'rgba(26, 115, 232, 0.08)',
    pastePreviewBorder: '#1a73e8',
    searchHighlightFill: 'rgba(251, 188, 4, 0.28)',
    searchHighlightBorder: '#f9ab00',
    dragGhostFill: 'rgba(26, 115, 232, 0.14)',
    dragGhostBorder: '#1a73e8',
